 ...
 * @author vujke
 */
public class SOVratiListuPretplata extends AbstractSO {

    private List<AbstractObjekat> pretplate;    
    
    @Override
    protected void izvrsiKonkretnuOperaciju() {
        pretplate = db.vratiSveObjekte(new Pretplata());
        ucitajClanovePakete();
    ...
    private void ucitajClanovePakete() {
        for (AbstractObjekat abs : pretplate) {
            try {
